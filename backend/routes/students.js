...
router.post('/', [
  ...
  body('phone').trim().notEmpty().withMessage('Phone number is required').matches(/^[\d+\s\-()]+$/).withMessage('Phone number can only contain numbers, +, spaces, dashes, and parentheses'),
...
router.put('/:id', [
  ...
  body('phone').optional().matches(/^[\d+\s\-()]+$/).withMessage('Phone number can only contain numbers, +, spaces, dashes, and parentheses'),
